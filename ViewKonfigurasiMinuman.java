 ...
 * @author User
 */
public class ViewKonfigurasiMinuman extends javax.swing.JFrame {

    public ViewKonfigurasiMinuman() {
        initComponents();
...
//        jPanelLeft.setMaximumSize(new Dimension(200, jPanelLeft.getHeight()));
        ...
        jLabel1.setIcon(Others.getScaledImage(180, 64, System.getProperty("user.dir")+"\\src\\main\\java\\assets\\Logo (1).png"));
...
//                jPanelRight.setBorder(new EmptyBorder(0,0,0,0));
                FinalProjectOOP.jPanelRightcrd.show(jPanelRight, "jPanelKonfigMinuman");
            }
        });
        // addActionListener jButtonKonfigurasiMinuman
        jButtonKonfigurasiMinuman.addActionListener(new ActionListener() {
        ...
        Others.jTableIsiTable(table, FinalProjectOOP.minuman);
        Others.jTableSetting(table);
            // 
        jPanelRight.add(jPanelRight1, "jPanelKonfigMinuman");
...
//        jButtonTambahData.setAlignmentY(JButton.CENTER_ALIGNMENT);
        ...
        JLabel jLabelTambah_Data = new JLabel("Tambah Minuman");
        ...
        jButtonTambah_DataSelesai.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    FinalProjectOOP.minuman.tambahMenu(
        ...
        jButtonHapus.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    FinalProjectOOP.minuman.hapusMenu(Integer.parseInt(jTextFieldHapusNomor.getText()));
                    Others.jTableIsiTable(table, FinalProjectOOP.minuman);
...
//        jPanelHapus.setLayout(new BoxLayout(jPanelHapus, BoxLayout.X_AXIS)); // set jPnaelHapus layout
        ...
        jButtonEditOke.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    jTextFieldEdit_DataNama.setText(FinalProjectOOP.minuman.daftarMenu.get(Integer.parseInt(jTextFieldEditNomor.getText())-1).nama);
                    jTextFieldEdit_DataHarga.setText(String.valueOf(FinalProjectOOP.minuman.daftarMenu.get(Integer.parseInt(jTextFieldEditNomor.getText())-1).harga));
        ...
        jButtonEdit_DataSelesai.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                FinalProjectOOP.minuman.editMenu(
    ...
    static class ItemAction implements ItemListener{
        ...
        public void itemStateChanged(ItemEvent e) {
            if (e.getStateChange() == 1) { 
                ViewKonfigurasiMinuman.jDialogJumlah.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewKonfigurasiMinuman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewKonfigurasiMinuman().setVisible(true);
            }
        });
    }
